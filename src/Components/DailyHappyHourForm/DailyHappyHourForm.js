      ...
      <tr>
          ...
          <select name='startingHours'
            onChange={(event)=> {
              this.props.handleChange(
                this.props.day, 'startingHours', event.target.value);
            }}>
            {hoursOptions}
          </select>
        </td>
        <td>
          <select name='endingHours'
            onChange={(event)=> {
              this.props.handleChange(
                this.props.day, 'endingHours', event.target.value);
            }}
          >
            {hoursOptions}
          </select>
        ...
        <td>
          <input name='special'
            onChange={(event) => {
              this.props.handleChange(
                this.props.day, 'special', event.target.value);
            }} />
        </td>
      </tr>
